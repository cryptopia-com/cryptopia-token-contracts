...
contract MockLayerZeroEndpointAlt is ILayerZeroEndpointV2, MessagingContext {
    ...
    function send(
    ...
    ) public virtual payable sendContext(_params.dstEid, msg.sender) returns (MessagingReceipt memory receipt) {
        ...
        MockLayerZeroEndpointAlt(lzEndpoint).receivePayload{ value: dstAmount }(
            origin,
    ...
    function nativeToken() external virtual view returns (address) {
        return nativeErc20;
    }
