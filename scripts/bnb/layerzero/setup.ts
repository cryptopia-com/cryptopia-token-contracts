...
import appConfig, { NetworkConfig } from "../../../app.bnb.config";
...
} from "../../../typechain-types/contracts/source/bnb/CryptosTokenBNB";
...
let tokenInstance: CryptosTokenBNB;
...
async function main() {
    ...
    const tokenAddress = deploymentManager.getContractDeployment("CryptosTokenBNB").address;
    tokenInstance = await ethers.getContractAt("CryptosTokenBNB", tokenAddress);
    ...
    {
        const mockEndpointAddress = deploymentManager.getContractDeployment("MockLayerZeroEndpoint:BNB").address;
