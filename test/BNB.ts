...
describe("BNB", function () {
    ...
    // Instances
    let cryptosTokenInstance: CryptosTokenBNB;
    ...
    before(async () => {
        ...
        // Factories
        const CryptosTokenFactory = await ethers.getContractFactory("CryptosTokenBNB");
        const LayerZeroEndpointFactory = await ethers.getContractFactory("MockLayerZeroEndpoint");
        
        // Deploy endpoint
        const layerZeroEndpointInstance = await LayerZeroEndpointFactory.deploy(eidBNB);
