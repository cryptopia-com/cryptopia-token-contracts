...
/**
 * CryptosToken on Skale Nebula
 */
describe("Skale Nebula", function () {
    ...
    // Instances
    let cryptosTokenInstance: CryptosTokenSkaleNebula;
    ...
    before(async () => {
        ...
        // Factories
        const CryptosTokenFactory = await ethers.getContractFactory("DevelopmentTokenSkaleNebula");
    ...
    describe("Deploy", function () {
        ...
        it("There should be zero tokens", async () => {
    ...
    describe("Failsafe", function () {
        ...
        // Instances
        let mockTokenInstance: MockToken;
